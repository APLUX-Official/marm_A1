...
easy_handeye2::msg::SampleList HandeyeServer::samplesToMessage() const
{
  easy_handeye2::msg::SampleList msg;
  ...
  std::shared_ptr<easy_handeye2::srv::ComputeCalibration::Response> response)
{
  ...
  if (last_calibration_) {
    ...
    response->calibration.transform = calib->getTransform();
...
void HandeyeServer::saveCalibrationCallback(
  const std::shared_ptr<easy_handeye2::srv::SaveCalibration::Request> request,
  std::shared_ptr<easy_handeye2::srv::SaveCalibration::Response> response)
{
  if (!last_calibration_) {
