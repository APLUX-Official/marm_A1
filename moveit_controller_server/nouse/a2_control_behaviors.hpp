...
public:
    explicit A2_Behavior_client(const std::string &name) : Node(name)
    {
        ...
        sub_camera_box_rec_ =
            this->create_subscription<geometry_msgs::msg::Point>(
                "transformed_pose_box", 1,
                std::bind(&A2_Behavior_client::camera_box_callback, this,
                          std::placeholders::_1));
        // hand 控制程序
...
public:
    ...
    void camera_box_callback(const geometry_msgs::msg::Point::SharedPtr point);
    void tf_pub_thread();
    ...
    void set_arm_target_pose(const std::vector<double> &target_pose,
                             ...
                             const bool use_cartesian = false,
...
public:
    ...
    geometry_msgs::msg::Point receive_camera_box_point;
    ...
    rclcpp::Time pose_receive_box_T;
